...
@Component({
  ...
  selector: 'jhi-launch-setting-detail',
  templateUrl: './launch-setting-detail.html',
  imports: [FontAwesomeModule, Alert, AlertError, TranslateDirective, TranslateModule, RouterLink, FormatMediumDatetimePipe],
})
export class LaunchSettingDetail {
  readonly launchSetting = input<ILaunchSetting | null>(null);
