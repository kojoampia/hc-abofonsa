...
import { LaunchSettingDeleteDialog } from './launch-setting-delete-dialog';

describe('LaunchSetting Management Delete Component', () => {
  let comp: LaunchSettingDeleteDialog;
  let fixture: ComponentFixture<LaunchSettingDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(LaunchSettingDeleteDialog);
