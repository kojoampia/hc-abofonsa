...
describe('SocialLink Management Delete Component', () => {
  let comp: SocialLinkDeleteDialog;
  let fixture: ComponentFixture<SocialLinkDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(SocialLinkDeleteDialog);
