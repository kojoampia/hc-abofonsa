...
@Component({
  ...
  templateUrl: './launch-milestone-delete-dialog.html',
  imports: [TranslateDirective, TranslateModule, FormsModule, FontAwesomeModule, AlertError],
})
export class LaunchMilestoneDeleteDialog {
  launchMilestone?: ILaunchMilestone;
  ...
  confirmDelete(id: number): void {
    this.launchMilestoneService.delete(id).subscribe(() => {
