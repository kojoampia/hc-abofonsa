...
import { PledgeTierTeaserDeleteDialog } from './pledge-tier-teaser-delete-dialog';

describe('PledgeTierTeaser Management Delete Component', () => {
  let comp: PledgeTierTeaserDeleteDialog;
  let fixture: ComponentFixture<PledgeTierTeaserDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PledgeTierTeaserDeleteDialog);
