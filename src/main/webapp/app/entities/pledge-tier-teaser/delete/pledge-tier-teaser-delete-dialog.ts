...
@Component({
  ...
  templateUrl: './pledge-tier-teaser-delete-dialog.html',
  imports: [TranslateDirective, TranslateModule, FormsModule, FontAwesomeModule, AlertError],
})
export class PledgeTierTeaserDeleteDialog {
  pledgeTierTeaser?: IPledgeTierTeaser;
  ...
  confirmDelete(id: number): void {
    this.pledgeTierTeaserService.delete(id).subscribe(() => {
