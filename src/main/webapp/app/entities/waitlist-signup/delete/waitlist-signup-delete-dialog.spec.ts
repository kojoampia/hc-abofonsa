...
import { WaitlistSignupDeleteDialog } from './waitlist-signup-delete-dialog';

describe('WaitlistSignup Management Delete Component', () => {
  let comp: WaitlistSignupDeleteDialog;
  let fixture: ComponentFixture<WaitlistSignupDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(WaitlistSignupDeleteDialog);
