...
@Component({
  ...
  selector: 'jhi-waitlist-signup-detail',
  templateUrl: './waitlist-signup-detail.html',
...
export class WaitlistSignupDetail {
  readonly waitlistSignup = input<IWaitlistSignup | null>(null);
