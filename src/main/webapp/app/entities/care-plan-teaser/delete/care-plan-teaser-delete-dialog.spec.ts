...
import { CarePlanTeaserDeleteDialog } from './care-plan-teaser-delete-dialog';

describe('CarePlanTeaser Management Delete Component', () => {
  let comp: CarePlanTeaserDeleteDialog;
  let fixture: ComponentFixture<CarePlanTeaserDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(CarePlanTeaserDeleteDialog);
