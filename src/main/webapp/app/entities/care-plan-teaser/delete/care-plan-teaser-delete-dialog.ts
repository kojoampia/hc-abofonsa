...
@Component({
  ...
  templateUrl: './care-plan-teaser-delete-dialog.html',
  imports: [TranslateDirective, TranslateModule, FormsModule, FontAwesomeModule, AlertError],
})
export class CarePlanTeaserDeleteDialog {
  carePlanTeaser?: ICarePlanTeaser;
  ...
  confirmDelete(id: number): void {
    this.carePlanTeaserService.delete(id).subscribe(() => {
