...
@Component({
  ...
  templateUrl: './pledge-tier-perk-delete-dialog.html',
  imports: [TranslateDirective, TranslateModule, FormsModule, FontAwesomeModule, AlertError],
})
export class PledgeTierPerkDeleteDialog {
  pledgeTierPerk?: IPledgeTierPerk;
  ...
  confirmDelete(id: number): void {
    this.pledgeTierPerkService.delete(id).subscribe(() => {
