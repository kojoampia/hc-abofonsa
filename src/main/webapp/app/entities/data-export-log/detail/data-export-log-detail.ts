...
@Component({
  ...
  selector: 'jhi-data-export-log-detail',
  templateUrl: './data-export-log-detail.html',
  imports: [FontAwesomeModule, Alert, AlertError, TranslateDirective, TranslateModule, RouterLink, FormatMediumDatetimePipe],
})
export class DataExportLogDetail {
  readonly dataExportLog = input<IDataExportLog | null>(null);
