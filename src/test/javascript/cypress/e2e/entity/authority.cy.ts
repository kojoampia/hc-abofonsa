...
describe('Authority e2e test', () => {
  ...
  let username: string;
  let password: string;
  const authoritySample = { name: '97e8a7ed-86db-425a-9c14-a8775e93b11f' };
  ...
  describe('Authority page', () => {
    it('should have translated page title', () => {
      ...
      cy.getEntityHeading('Authority').should('not.contain', 'abofonsaPreviewApp.adminAuthority.home.title');
    });
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('5a7af7ff-5fbf-4a0e-9d09-0cc7b9b52f0d');
      cy.get(`[data-cy="name"]`).should('have.value', '5a7af7ff-5fbf-4a0e-9d09-0cc7b9b52f0d');
